...
num2='ten'
num2=true
console.log("num any: ", num2)


// ***** unknown *****
// The unknow is a safer alternative to any because it still enforce type checking  and type safety.
// Variables of type unknow can hold values of any type, but you must perform type checking and
...
if(typeof num3 === 'string'){
    console.log("It is string: ", num3)
}
else if(typeof num3 === 'boolean'){
    console.log("It is boolean: ", num3)
}
